...
public class ProductoVO {
    ...
    public ProductoVO(int idProducto, String nombreProducto, String descripcionProducto, double precioUnitarioProducto, double stockProducto, double unidadMinimaProducto, String nombreImgProducto, int idMarca, int idCategoria) {
    ...
    public ProductoVO(String nombreImgProducto) {
        this.nombreImgProducto = nombreImgProducto;
    }
