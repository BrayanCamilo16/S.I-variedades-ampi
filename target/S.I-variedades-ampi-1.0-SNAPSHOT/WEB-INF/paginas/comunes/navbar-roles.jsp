    ...
    <body>
        ...
        <header class="headerr-usuario">
            ...
            <div class="admin-modale">
                ...
                <img src="${pageContext.request.contextPath}/img/admin.png" style="border-radius: 50%; width: 35px;"/>
                <input type="checkbox" id="salir">
                <label for="salir"><i class="ion-md-arrow-dropdown" style="font-size: 23px; cursor: pointer; color: #0F42A6;"></i></label>
                <div class="modales">
        ...
        <header class="headerr-usuario">
            ...
            <div class="admin-modale">
                <p>${usuarioVo.nombreUsuario}  ${usuarioVo.apellidoUsuario}</p>
                <img src="${pageContext.request.contextPath}/img/vendedor.jpg" style="border-radius: 50%; width: 35px;"/>
                <input type="checkbox" id="salir">
                <label for="salir"><i class="ion-md-arrow-dropdown" style="font-size: 23px; cursor: pointer; color: #0F42A6;"></i></label>
                <div class="modales">
                    <div class="contenedorr">
        ...
        <header class="headerr-usuario">
            ...
            <div class="admin-modale">
                <p>${usuarioVo.nombreUsuario}  ${usuarioVo.apellidoUsuario}</p>
                <img src="${pageContext.request.contextPath}/img/cliente.png" style="border-radius: 50%; width: 35px;"/>
                <input type="checkbox" id="salir">
                <label for="salir"><i class="ion-md-arrow-dropdown" style="font-size: 23px; cursor: pointer; color: #0F42A6;"></i></label>
                <div class="modales">
                    <div class="contenedorr">
